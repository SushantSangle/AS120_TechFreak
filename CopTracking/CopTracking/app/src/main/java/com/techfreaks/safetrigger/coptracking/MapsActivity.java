...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, com.google.android.gms.location.LocationListener, RoutingListener {

    private static final int[] COLORS = new int[]{R.color.colorAccent};
    //Declaring all required views and objects.
    private GoogleMap mMap;
    private String assignedCitizenID, complaint_id, citizenName, uid, profile_image_url, navCoordinatesUri, name, id, email, phone;
    ...
    private long UPDATE_INTERVAL = 10000;  /* 3 secs */
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    try {
                        ...
                        Log.e("Reported ", "complaint in maps", e);
                    }
...
//        LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, MapsActivity.this);
        ...
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        //Passing complaint_id to the Complaaccept karun gap basu!
        // intForwarded Activity.
        intent.putExtra("complaint_id", complaint_id);
        finish();
        startActivity(intent);
