...
public class Status extends AppCompatActivity implements Api.ApiOptions.HasOptions,
    ...
    private String uid,phone,email,name,id;
        ...
        getFusedLocationProviderClient(this).requestLocationUpdates(mLocationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        try{
                            ...
                            Log.e("as", "onLocationResult: "+e.toString());
                        }
                    }
                },
                Looper.myLooper());
